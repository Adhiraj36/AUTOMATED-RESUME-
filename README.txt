...
The first time you run the app, the Sentence Transformer model (approx. 90MB) will be downloaded automatically.
pip install streamlit pandas pdfplumber sentence-transformers torch
